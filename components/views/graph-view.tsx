  ...
  return (
    <main className="flex h-full min-h-0 flex-1 flex-col overflow-hidden bg-background">
      ...
      <div className="relative flex min-h-0 flex-1 overflow-hidden">
        <section aria-label="Interactive swarm graph" className="graph-grid relative min-h-[440px] flex-1 overflow-hidden">
          ...
          <div className="absolute bottom-4 right-4 flex gap-1 rounded-xl border border-border bg-card/80 p-1 backdrop-blur"><button className="rounded-lg px-2 py-1 text-sm text-muted-foreground hover:bg-secondary">−</button><span className="px-1 py-1 text-xs text-muted-foreground">100%</span><button className="rounded-lg px-2 py-1 text-sm text-muted-foreground hover:bg-secondary">+</button></div>
        </section>
